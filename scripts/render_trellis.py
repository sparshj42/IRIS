...
pts = np.load("output_trellis/labeled_pointcloud_points.npy")
lab = np.load("output_trellis/labeled_pointcloud_labels.npy")
...
plt.tight_layout(); plt.savefig("result_trellis_cloud.png", dpi=90, bbox_inches="tight")
print("saved result_trellis_cloud.png")
